...
bb8:
  %r254 = phi i32 [ %r252, %bb6 ], [ %r261, %bb12 ]
  %r255 = phi i32 [ %r251, %bb6 ], [ %r262, %bb12 ]
  %r256 = phi i32 [ %r253, %bb6 ], [ %r263, %bb12 ]
  %r125 = load i32, i32* @n
  %r126 = icmp sle i32 %r256, %r125
  br i1 %r126, label %bb9, label %bb10

bb9:
  %r129 = getelementptr [16 x i32 ], [16 x i32 ]* @dis, i32 0, i32 %r256
  %r130 = load i32, i32* %r129
  %r131 = icmp sgt i32 %r255, %r130
  br i1 %r131, label %bb13, label %bb12

bb13:
  %r133 = getelementptr [16 x i32 ], [16 x i32 ]* @book, i32 0, i32 %r256
  %r134 = load i32, i32* %r133
  %r135 = icmp eq i32 %r134, 0
  br i1 %r135, label %bb11, label %bb12

bb11:
  %r137 = getelementptr [16 x i32 ], [16 x i32 ]* @dis, i32 0, i32 %r256
...
bb12:
  %r261 = phi i32 [ %r254, %bb9 ], [ %r254, %bb13 ], [ %r265, %bb11 ]
  %r262 = phi i32 [ %r255, %bb9 ], [ %r255, %bb13 ], [ %r264, %bb11 ]
  %r141 = add i32 %r256, 1
  %r263 = add i32 %r141, 0
  br label %bb8

bb10:
  %r143 = getelementptr [16 x i32 ], [16 x i32 ]* @book, i32 0, i32 %r254
...
bb15:
  %r149 = getelementptr [16 x %array2D ], [16 x %array2D ]* @e, i32 0, i32 %r254
...
bb17:
  ...
  %r160 = getelementptr [16 x i32 ], [16 x i32 ]* @dis, i32 0, i32 %r254
  %r161 = load i32, i32* %r160
  %r163 = getelementptr [16 x %array2D ], [16 x %array2D ]* @e, i32 0, i32 %r254
...
bb19:
  ...
  %r173 = getelementptr [16 x i32 ], [16 x i32 ]* @dis, i32 0, i32 %r254
  %r174 = load i32, i32* %r173
  %r176 = getelementptr [16 x %array2D ], [16 x %array2D ]* @e, i32 0, i32 %r254
